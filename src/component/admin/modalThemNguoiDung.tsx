...
export default function ModalThemNguoiDung({ open, onClose }: ModalThemNguoiDungProps) {
  ...
  return (
    ...
    >
      ...
      >
        <h3 id="add-user-title" className="mb-4 text-xl font-bold">
          Thêm người dùng
        </h3>
