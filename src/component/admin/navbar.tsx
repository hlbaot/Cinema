    ...
    <>
      <div className="border-b border-gray-800 p-5">
        <Link href="/admin/overView" className="flex items-center gap-3" onClick={() => setMobileOpen(false)}>
          ...
          <div>
            <h1 className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-lg font-bold text-transparent">CINEPRO</h1>
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto p-4">
        {adminLinks.map((link) => {
          ...
          return (
            ...
            >
              <span className={`transition-transform group-hover:scale-110 ${active ? "text-purple-400" : "text-gray-500"}`}>{link.icon}</span>
