  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:max-w-6xl lg:px-8">
      <div className="mb-6 flex items-end justify-between gap-4 lg:mb-7">
        <div>
          <h2 className="text-xl font-bold text-white sm:text-2xl lg:text-[1.75rem]">Danh sách phim sắp chiếu</h2>
          <p className="mt-1 text-sm text-gray-400">Những bộ phim sắp ra mắt tại CinePro</p>
        </div>
