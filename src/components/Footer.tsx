      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Hệ thống rạp chiếu phim cao cấp hàng đầu Việt Nam với công nghệ IMAX, Dolby Atmos và dịch vụ Gold Class đẳng cấp.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-bold mb-4">Về CINEPRO</h4>
            <ul className="space-y-2">
              {['Giới thiệu', 'Hệ thống rạp', 'Tuyển dụng', 'Liên hệ quảng cáo'].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['IMAX', 'Gold Class', 'Dolby Atmos', '4DX', 'Thuê rạp'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-gray-400 text-sm hover:text-yellow-400 transition-colors">
                    {item}
                  </a>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2 text-gray-400 text-sm">
                ...
                <span>Landmark 81, Q. Bình Thạnh, TP.HCM</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-10 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © 2024 CINEPRO. All rights reserved.
          </p>
