export const dataMovie = [
    ...
    },
    {
        ...
        description: "Người Nhện (Spider-Man) là một bộ phim siêu anh hùng nổi tiếng được ra mắt vào năm 2002, đánh dấu bước đầu tiên trong loạt phim về siêu anh hùng nổi tiếng này. Phim kể về câu chuyện của cậu thiếu niên Peter Parker, người sau khi bị nhện biến đổi gen cắn đã nhận được siêu năng lực đặc biệt. Ban đầu, Peter là một cậu học sinh nhút nhát và bị bắn ghét bởi bạn bè và đồng nghiệp.",
        minutes: 121,
        status: "Sắp ra mắt",
    },
    {
